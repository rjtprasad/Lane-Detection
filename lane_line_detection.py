...
st.set_page_config(page_title="Lane Detection")
...
st.title('Lane Detection For Self Driving Car')

html_link = """
        <a href="https://github.com/rjtprasad/Lane-Detection" style="color:green;" target="_blank">Github</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
